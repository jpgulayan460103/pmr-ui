...
const initialState = () => {
  ...
  export default function reducer(state = initialState(), action) {
    switch (action.type) {
      ...
      case 'SET_PROCUREMENT_PLAN_LIST_PAGINATION_META':
        return {
          ...state,
          paginationMeta: action.data,
        };
      case 'SET_PROCUREMENT_PLAN_LIST_LOADING':
        return {
          ...state,
          loading: action.data,
        };
      case 'SET_PROCUREMENT_PLAN_LIST_TIMELINES':
        return {
          ...state,
          timelines: action.data,
        };
      case 'SET_PROCUREMENT_PLAN_LIST_LOGGER':
        return {
          ...state,
          logger: action.data,
        };
      case 'SET_PROCUREMENT_PLAN_TABLE_FILTER':
        return {
          ...state,
          tableFilter: action.data,
        };
      case 'SET_PROCUREMENT_PLAN_TAB':
        return {
          ...state,
          tab: action.data,
        };
